...
${OBJECTDIR}/question_1.o: question_1.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_1.o question_1.cpp

${OBJECTDIR}/question_10.o: question_10.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_10.o question_10.cpp

${OBJECTDIR}/question_11.o: question_11.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_11.o question_11.cpp

${OBJECTDIR}/question_12.o: question_12.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_12.o question_12.cpp

${OBJECTDIR}/question_2.o: question_2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_2.o question_2.cpp

${OBJECTDIR}/question_3.o: question_3.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_3.o question_3.cpp

${OBJECTDIR}/question_4.o: question_4.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_4.o question_4.cpp

${OBJECTDIR}/question_5.o: question_5.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_5.o question_5.cpp

${OBJECTDIR}/question_6.o: question_6.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_6.o question_6.cpp

${OBJECTDIR}/question_7.o: question_7.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_7.o question_7.cpp

${OBJECTDIR}/question_8.o: question_8.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_8.o question_8.cpp

${OBJECTDIR}/question_9.o: question_9.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_9.o question_9.cpp
...
${TESTDIR}/tests/question_1_test.o: tests/question_1_test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/question_1_test.o tests/question_1_test.cpp


${TESTDIR}/tests/question_10_test.o: tests/question_10_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/question_10_test.o tests/question_10_test.cpp
...
${TESTDIR}/tests/question_2_test.o: tests/question_2_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/question_2_test.o tests/question_2_test.cpp


${TESTDIR}/tests/question_3_test.o: tests/question_3_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/question_3_test.o tests/question_3_test.cpp


${TESTDIR}/tests/question_4_test.o: tests/question_4_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/question_4_test.o tests/question_4_test.cpp


${TESTDIR}/tests/question_5_test.o: tests/question_5_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/question_5_test.o tests/question_5_test.cpp


${TESTDIR}/tests/question_6.o: tests/question_6.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/question_6.o tests/question_6.cpp


${TESTDIR}/tests/question_7_test.o: tests/question_7_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/question_7_test.o tests/question_7_test.cpp


${TESTDIR}/tests/question_8_test.o: tests/question_8_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/question_8_test.o tests/question_8_test.cpp


${TESTDIR}/tests/question_9_test.o: tests/question_9_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/question_9_test.o tests/question_9_test.cpp
...
${OBJECTDIR}/question_1_nomain.o: ${OBJECTDIR}/question_1.o question_1.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_1_nomain.o question_1.cpp;\
	else  \
...
${OBJECTDIR}/question_10_nomain.o: ${OBJECTDIR}/question_10.o question_10.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_10_nomain.o question_10.cpp;\
	else  \
...
${OBJECTDIR}/question_11_nomain.o: ${OBJECTDIR}/question_11.o question_11.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_11_nomain.o question_11.cpp;\
	else  \
...
${OBJECTDIR}/question_12_nomain.o: ${OBJECTDIR}/question_12.o question_12.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_12_nomain.o question_12.cpp;\
	else  \
...
${OBJECTDIR}/question_2_nomain.o: ${OBJECTDIR}/question_2.o question_2.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_2_nomain.o question_2.cpp;\
	else  \
...
${OBJECTDIR}/question_3_nomain.o: ${OBJECTDIR}/question_3.o question_3.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_3_nomain.o question_3.cpp;\
	else  \
...
${OBJECTDIR}/question_4_nomain.o: ${OBJECTDIR}/question_4.o question_4.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_4_nomain.o question_4.cpp;\
	else  \
...
${OBJECTDIR}/question_5_nomain.o: ${OBJECTDIR}/question_5.o question_5.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_5_nomain.o question_5.cpp;\
	else  \
...
${OBJECTDIR}/question_6_nomain.o: ${OBJECTDIR}/question_6.o question_6.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_6_nomain.o question_6.cpp;\
	else  \
...
${OBJECTDIR}/question_7_nomain.o: ${OBJECTDIR}/question_7.o question_7.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_7_nomain.o question_7.cpp;\
	else  \
...
${OBJECTDIR}/question_8_nomain.o: ${OBJECTDIR}/question_8.o question_8.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_8_nomain.o question_8.cpp;\
	else  \
...
${OBJECTDIR}/question_9_nomain.o: ${OBJECTDIR}/question_9.o question_9.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/question_9_nomain.o question_9.cpp;\
	else  \
